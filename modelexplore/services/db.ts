...
// Changed to named import for better TypeScript type resolution of the Dexie class
...
const STORAGE_KEY = 'modelexplorer_pro_v4_storage';
...
export class ModelExplorerDB extends Dexie {
...
export const db = new ModelExplorerDB();
