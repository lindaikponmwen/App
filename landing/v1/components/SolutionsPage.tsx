...
const SolutionsPage: React.FC = () => {
  ...
  return (
    <div className="bg-slate-50 min-h-screen pb-20">
      ...
      <div className="bg-[#020617] text-white py-16 lg:py-24 px-6 relative overflow-hidden">
        {/* Background Grids */}
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          <p className="text-lg md:text-xl text-slate-400 max-w-3xl mx-auto font-light leading-relaxed mb-10">
      ...
      {/* Solutions Grid */}
      <div className="max-w-7xl mx-auto px-6 -mt-8 md:-mt-16 relative z-20">
                ...
                <ul className="space-y-3 mb-8">
                  {sol.features.map((feat, i) => (
                    <li key={i} className="flex items-center gap-3 text-sm text-slate-700 font-medium">
                      <div className="w-1.5 h-1.5 bg-brand-primary shrink-0"></div>
                      {feat}
                    </li>
                  ))}
                </ul>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16 lg:mt-24">
        <div className="bg-white border-l-4 border-brand-primary p-8 lg:p-12 shadow-sm flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
          ...
          <div className="flex gap-4 shrink-0">
             ...
             <ArrowRight className="text-slate-300" size={36} />
             <LineChart className="text-brand-primary" size={36} />
          </div>
        </div>
      </div>
    </div>
