...
const ContactForm: React.FC = () => {
  ...
  return (
    <section id="request-demo" className="bg-white border-t border-gray-100 relative">
      ...
      <div className="bg-[#020617] text-white py-16 lg:py-20 px-6 text-center relative overflow-hidden">
      ...
      {/* Form Container */}
      <div className="max-w-4xl mx-auto py-12 lg:py-20 px-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            
            {/* Left: Value Props */}
            <div className="lg:col-span-1 space-y-6 lg:space-y-8 pt-4">
            ...
            <div className="lg:col-span-2">
                ...
                <form onSubmit={handleSubmit} className="space-y-6 bg-slate-50 p-6 md:p-8 border border-gray-200 shadow-sm relative">
