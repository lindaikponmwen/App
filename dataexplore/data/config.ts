...
export const APP_CONFIG = {
  ...
  // Set this to true to enable PHP/S3 Backend integration
  enableCloudSync: true, 
  apiEndpoints: {
    getProjectFiles: '/project-api/get_project_files_by_uid.php',
    generateUrl: '/project-api/generate-presigned-url.php',
    logFile: '/project-api/log_file.php'
  },
