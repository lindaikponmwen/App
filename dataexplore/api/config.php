...
define('ALLOWED_ORIGIN', getenv('ALLOWED_ORIGIN') ?: '*'); // Default to * for dev, restrict in prod

// AWS Credentials
define('AWS_ACCESS_KEY_ID', getenv('AWS_ACCESS_KEY_ID') ?: 'YOUR_ACCESS_KEY');
define('AWS_SECRET_ACCESS_KEY', getenv('AWS_SECRET_ACCESS_KEY') ?: 'YOUR_SECRET_KEY');
define('AWS_DEFAULT_REGION', getenv('AWS_DEFAULT_REGION') ?: 'us-east-1');
define('AWS_BUCKET', getenv('AWS_BUCKET') ?: 'your-bucket-name');
